...
| 3 | **GitHub issue linkage** — Auto-create GitHub issues on report submit. Wire `github_issue:` backlink into frontmatter. Sync existing reported issues. | `src/webui/src/routes/api/issues/report/create/+server.ts` — GH API integration; backfill script | ✅ Done |
