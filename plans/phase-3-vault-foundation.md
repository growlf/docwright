...
| 2 | Contribution pipeline tools on dw-upstream | **Delegated to `plans/contribution-pipeline.md`** — that plan is the authoritative spec for Steps 1–3 (contribute_upstream, log_friction, list_docwright_issues). See sub-plan for full details. Does not gate Phase 3. | ⏳ Pending | — | — |
